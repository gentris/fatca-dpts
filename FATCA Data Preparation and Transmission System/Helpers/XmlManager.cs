...
namespace FATCA_Data_Preparation_and_Transmission_System.Helpers
{
    ...
    class XmlManager
    {
        ...
        /// <param name="signWithSha256">Sign the document using SHA-256</param>
        /// <returns>X509Certificate2 object</returns>
        private static X509Certificate2 LoadSigningCertificate(byte[] certFile, string certPassword, bool signWithSha256)
        {
            X509Certificate2 certificate = null;
        ...
        /// <param name="signWithSha256">Sign the document using SHA-256</param>
        /// <returns>The signed data represented as byte array</returns>
        private static byte[] SignEnvelopingXml(XmlSignatureType signatureType, byte[] xml, byte[] certFile, string certPassword, bool signWithSha256, string encodingPath = "")
        {
            if (xml == null || xml.Length == 0)
            {
                // invalid XML array
        ...
        /// <param name="signWithSha256">Sign the document using SHA-256</param>
        /// <returns>The signed data represented as byte array</returns>
        public static byte[] Sign(XmlSignatureType signatureType, byte[] xml, byte[] certFile, string certPassword, string encodingPath, bool signWithSha256 = true)
        {
            switch (signatureType)
            {
